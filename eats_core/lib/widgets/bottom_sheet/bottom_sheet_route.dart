...
class DModalBottomSheetRoute<T> extends PageRoute<T> {
  ...
  @override
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) => nextRoute is DModalBottomSheetRoute;
  ...
  bool canTransitionFrom(TransitionRoute<dynamic> previousRoute) {
    ...
    try {
      if (previousRoute.settings.arguments != null) {
        isAnimated = (previousRoute.settings.arguments as Map)['isAnimated'] as bool;
      } else {
        isAnimated = true;
      }
    } catch (e) {
    ...
    return (previousRoute is DModalBottomSheetRoute || previousRoute is PageRoute) && isAnimated;
  }
