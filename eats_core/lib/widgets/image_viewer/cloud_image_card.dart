...
import 'package:eats_core/animations/animations.dart';
import 'package:eats_core/models/cloud_image/cloud_image.dart';
import 'package:eats_core/models/cloud_image/image_resolution_options.dart';
...
class CloudImageCard extends StatefulWidget {
  const CloudImageCard(
      {Key? key,
      required this.image,
      this.resolutionOptions = ImageResolutionOptions.large})
      : super(key: key);
