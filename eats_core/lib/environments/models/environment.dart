...
import 'package:eats_core/environments/enums/environment_type.dart';
import 'package:eats_core/services/enum_services.dart';

export 'package:eats_core/services/enum_services.dart';
...
class Environment {
  ...
  factory Environment.fromMap(Map<String, dynamic> map) {
    return Environment(
        type: enumFromString(EnvironmentType.values, map['type']));
  }
