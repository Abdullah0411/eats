...
import 'package:eats_core/enums/currency.dart';
import 'package:eats_core/models/coupon_usage.dart';
import 'package:eats_core/models/flutter_timestamp.dart';
import 'package:eats_core/services/enum_services.dart';
...
class Coupon {
  ...
  factory Coupon.fromMap(Map<String, dynamic> map) {
    return Coupon(
      ...
      couponUsage:
          CouponUsage.toListFromMap(map['couponUsage'] as Map<String, dynamic>),
      currency: map['currency'] != null
          ? enumFromString(Currency.values, map['currency'] as String)
          : null,
    );
  }
  ...
  String get discount {
    ...
    if (isFixedAmount) {
      discountString =
          discountAmount!.toStringAsFixed(2) + getEnumReadable(currency, 'ar');
    } else {
