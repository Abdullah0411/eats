...
import 'package:eats_core/widgets/conditionary_widget/conditionary_widget.dart';
...
class _CustomButtonState extends State<CustomButton> {
  ...
  void didChangeDependencies() {
    ...
    if (widget.style != null) {
      ...
      _color = widget.color ?? AppColors.darkGreenTerquise;
      _hoverColor = AppColors.darkGreenTerquise;
  ...
  Color _getColorFromStyle() {
    switch (widget.style) {
      case CustomButtonStyle.primary:
        return AppColors.darkGreenTerquise;
      case CustomButtonStyle.secondary:
        return AppColors.darkGreenTerquise.withOpacity(0.15);
